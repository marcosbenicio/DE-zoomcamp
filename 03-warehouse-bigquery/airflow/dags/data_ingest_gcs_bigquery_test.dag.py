...
# [START DAG Object] 
workflow = DAG(
                dag_id="data_ingest_gcs_bigquery_test",
...
with workflow:
    ...
    download_task = BashOperator(
        ...
        #bash_command=f'wget -O {OUTPUT_FILE_PATH} {URL}'
    )   
    ...
    bigquery_external_table = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            'tableReference': {
                ...
                'tableId': "green_taxi_2022_07",
            },
            'externalDataConfiguration': {
                'sourceFormat': 'PARQUET',
                'sourceUris': [f"gs://{BUCKET_NAME}/{GCS_BUCKET_FOLDER}green_tripdata_2022-07.parquet"],
            }
        },
        gcp_conn_id="gcp"
    )
download_task >> create_bucket >> ingest_data_gcs >> create_empty_dataset >> bigquery_external_table
# [END Workflow] 